...
const Contacts: React.FC = () => {
  return <section className='contacts'>
    ...
    <div className='contacts__container'>
      ...
      <p className='contacts__phone-time'>для заказов с доставкой по территории РФ принимаем звонки с 9:00 до 22:00 по Мск</p>
    </div>
    <div className='contacts__container'>
      <p className='contacts__info'>{ contactsData.email }</p>
      <p className='contacts__phone-time'>для заказов с доставкой по территории РФ
принимаем звонки с 9:00 до 22:00 по Мск</p>
    </div>
