...
const Cart: FC<CartProps> = ({ onCheckoutClick }) => {
  ...
  const { cartItems, totalCount, totalDiscount, sumValue, totalSumValue } = useCartContext();
    ...
    <section className='cart'>
      <div className='cart__container'>
        ...
        {/* If cart is empty: */}
          ...
          <p className='cart__default-info-p'>переходите в каталог или воспользуйтесь поиском,</p>
          <p className='cart__default-info-p'>если ищете что-то конкретное</p>
          </div>
              ...
              <div className='cart__order-info'>
                <div className='cart__order-info-wrapper'>
                  <span className='cart__order-info-sum'>
                    {totalCount} товара на сумму {/* Общее количество товаров в списке */}
                  </span>
                ...
                <div className='cart__order-info-wrapper'>
                  ...
                  <span className='cart__order-info-sum-number'>
                    <span>- </span>{formatCurrency(totalDiscount)}
                  </span>
                </div>
              </div>
