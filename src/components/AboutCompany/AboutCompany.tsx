        ...
        <li className='about-company__feature'>
          ...
          <div className='about-company__feature-content'>
            ...
            <p className='about-company__feature-text'>
              ...
              приемлемую стоимость. Потому что крутая техника облегчает жизнь и
              доставляет удовольствие — пусть ее у всех будет больше.
            </p>
          </div>
        </li>
        <li className='about-company__feature'>
          ...
          <div className='about-company__feature-content'>
            <p className='about-company__feature-text'>
              У нас работает доставка до двери и самовывоз. Большинство заказов
              доставляем в день оформления либо на следующий день. Возможна
              оплата на сайте или при получении.
            </p>
            <p className='about-company__feature-text'>
              Срок и стоимость доставки в регионы рассчитывается автоматически,
              когда вы оформляете заказ, но в этом случае мы просим сразу внести
              оплату.
            </p>
            <p className='about-company__feature-text'>
        ...
        <li className='about-company__feature'>
          ...
          <div className='about-company__feature-content'>
            <p className='about-company__feature-text'>
              ...
              Продаем только оригинальную технику. Выбираем проверенные бренды и
              новинки.
            </p>
          </div>
        </li>
