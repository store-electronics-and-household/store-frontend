          ...
          <div className='delivery__content'>
            <div className='delivery__info'>
              ...
              <div className='delivery__info-wrapper'>
                ...
                <span className='delivery__info-description'>
                  Заказ можно забрать в нашем магазине в Санкт-Петербурге. Перед
                  приездом необходимо зарезервировать товар.
                </span>
            ...
            <div className='delivery__info'>
              ...
              <div className='delivery__info-wrapper'>
                ...
                <span className='delivery__info-description'>
                  По Санкт-Петербургу и пригородам курьер доставит заказ в
                  удобное для вас время. Возможна экспресс доставка в течении 3х
                  часов.
                </span>
                <span className='delivery__info-highlight'>
            ...
            <div className='delivery__info'>
              ...
              <div className='delivery__info-wrapper'>
                ...
                <span className='delivery__info-description'>
                  ...
                  вашем городе или оформить доставку до двери.
                </span>
                <span className='delivery__info-highlight'>
                  Доставка до пункта выдачи: 200 ₽
                </span>
              </div>
            </div>
          </div>
