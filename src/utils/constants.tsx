...
export const aboutCompanyInfo = [
  {
    ...
    text: ['У нас есть офлайновая торговая точка и&nbsp;интернет&#8209;магазин. Продаем смартфоны, компьютеры, «умные» часы и браслеты, кофемашины и др.',
  ...
  },
  {
    ...
    text: ['У нас работает доставка до двери и самовывоз. Большинство заказов доставляем в день оформления либо на следующий день. Возможна оплата на сайте или при получении.',
  ...
  },
  {
    ...
    iconSrc: iconMedal,
    altText: 'Супер быстрая доставка, транспорт',
    text: ['У нас вы не встретите подделок и устаревших моделей товаров. Продаем только оригинальную технику. Выбираем проверенные бренды и новинки.']
  }
];
