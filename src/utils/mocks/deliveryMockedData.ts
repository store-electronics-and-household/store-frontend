...
export const mockedDeliveryData = [
  {
    ...
    icon: carIcon,
    alt: 'Самовывоз',
    description: 'Заказ можно забрать в нашем магазине в Санкт-Петербурге. Перед приездом необходимо зарезервировать товар',
    highlight: [
  ...
  },
  {
    ...
    description: 'Вы можете забрать свой заказ в одном из пунктов выдачи СДЭК в вашем городе или оформить доставку до двери.',
    highlight: [
